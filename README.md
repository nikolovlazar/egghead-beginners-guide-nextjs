...
- `Exercise 05` - [Provide page-specific metadata](exercises/exercise-05--provide-page-specific-metadata)
- `Exercise 06` - [Use `next/image` for Image Optimization](exercises/exercise-06--use-next-image-for-image-optimization)
